...
```
createdb -h localhost -U ctp_user Simply_Financial
```

> You will create a DB for each project you start based on this repo. For other projects change `Simply_Financial` to the new apps database name.
